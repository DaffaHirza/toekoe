...
<body>
    ...
    <div class="summary">
        <strong style="color: #ef4444;">⚠ Produk Perlu Restock:</strong> <span
            class="summary-value">{{ $totalProducts }}</span>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($products as $i => $p)
                <tr>
                    ...
                    <td class="center"><span class="warning">{{ $p->stok }}</span></td>
    ...
    <div class="footer">
        <p><strong>⚠ PERHATIAN:</strong> Produk dengan stok < 2 harus segera dipesan | © 2025 Toko Elektronik</p>
    </div>
</body>
