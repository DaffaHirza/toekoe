            ...
            <div class="flex items-center gap-8 ml-auto">
                <div class="flex items-center space-x-6">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5 cursor-pointer fill-slate-800 hover:fill-[#077bff]" viewBox="0 0 511 511.999">
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5 cursor-pointer fill-slate-800 hover:fill-[#077bff]"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5 cursor-pointer fill-slate-800 hover:fill-[#077bff]" viewBox="0 0 24 24">
                        <path
                ...
                <div class="dropdown-menu relative flex shrink-0 group items-center gap-3">
                    ...
                    <div
                        class="dropdown-content hidden group-hover:block shadow-md p-2 bg-white rounded-md absolute top-12 right-0 w-56 z-50">
                        <div class="w-full">
                            ...
                            {{-- <ul id="dropdownMenu"
                                ...
                                <li class="hover:bg-slate-50 transition-colors">
                                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                                        @csrf
                                        <button type="submit"
                                            class="flex items-center w-full py-2.5 px-5 text-slate-600 hover:text-[#1154d4] transition-colors group">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="w-4 h-4 mr-3 fill-current group-hover:fill-[#1154d4] transition-colors"
